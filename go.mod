...
require (
	...
	github.com/spiral/roadrunner-plugins/v2 v2.5.0-alpha.1
	github.com/spiral/roadrunner/v2 v2.5.0-alpha.1
	// ---------------------
	github.com/stretchr/testify v1.7.0
	// SPIRAL --------------
	github.com/temporalio/roadrunner-temporal v1.0.10-alpha.1
	// ---------------------
